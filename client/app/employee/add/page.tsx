      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        <div className="max-w-2xl">
          <Alert variant="success">
            ...
            <AlertTitle>Employee Added Successfully!</AlertTitle>
            <AlertDescription className="mt-2 space-y-4">
              <div>
                <p className="text-sm mb-2">Credentials have been sent to the employee&apos;s email. Share these details:</p>
              </div>
              ...
              <Alert variant="warning">
                ...
                <AlertDescription>
                  The employee should change their password immediately after the first login.
                </AlertDescription>
              </Alert>
